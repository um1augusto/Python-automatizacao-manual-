...
while procurar:
    try:
        ...
        if localizar_e_clicar('race.png', confidence=0.7, descricao="Primeira imagem (claim)"):
            time.sleep(1)

        if localizar_e_clicar('fechar.png', confidence=0.6, descricao="Segunda imagem (fechar)"):
            time.sleep(2)
            localizar_e_clicar('fechar.png', confidence=0.7, descricao="Terceira imagem (farmar)")
